...
public class Tp02Part3Application {

    public static void main(String[] args) {

        SpringApplication.run(Tp02Part3Application.class, args);
    }
